...
param_info = {
    ...
    'Solids': {'min': 100.0, 'max': 2000.0, 'desc': 'Total dissolved solids (TDS) in ppm. Ideal range is 300-500 ppm (for good taste and mineral balance).', 'step': 100.0, 'default': 20000.0},
